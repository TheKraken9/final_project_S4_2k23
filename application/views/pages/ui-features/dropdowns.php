            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Listes des régimes</h4>
                                <p class="card-description">
                                    Les régimes <code>.tout</code>
                                </p>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-success">
                                                <?php if($item->type == "Perdre du poids"){ ?>
                                                    <i class="ti-arrow-down"> <?= $item->type ?></i>
                                                <?php }else{ ?>
                                                    <i class="ti-arrow-up"> <?= $item->type ?></i>
                                                <?php } ?>
                                            </td>
                                            <td><label class="badge badge-warning m-2"><a href="<?= site_url("/index.php/First/modifier?id="); ?><?= $item->id ?>" class="text-white">Modifier</a></label><label class="badge badge-danger"><a href="<?= site_url("/index.php/First/supprimer?id="); ?><?= $item->id ?>" class="text-white">Supprimer</a></label></td>
                                        </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
