				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li>
								<a href="<?= site_url("/index.php/Front/generer_imc"); ?>">Mon IMC</a>
							</li>

							<li>
								<a href="<?= site_url("/index.php/Welcome/premium"); ?>" class="text-danger">Devenir Premium</a>
							</li>
						</ul>
					</div>
					<!-- Icon header -->
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="<?= site_url("/index.php/Welcome/logout"); ?>" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11" >
					...
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
							...
							<div class="layer-slick1 animated visible-false" data-appear="zoomIn" data-delay="1600">
								<a href="<?=site_url('/index.php/Welcome/commencer') ?>" class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04">
                                    Commencer mon régime
								</a>
							</div>
						</div>
					</div>
