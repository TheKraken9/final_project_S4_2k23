...
<body class="animsition">
			...
			<div class="wrap-menu-desktop how-shadow1">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="<?= site_url("/index.php/Welcome/logout"); ?>" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti" data-notify="0">
    ...
    <div class="container mt-5">
        <form method="post" action="<?= site_url("/index.php/Third/inserer_request"); ?>">
            <input class="stext-104 cl2 plh4 size-117 bor13 p-lr-20 m-r-10 " type="number" name="code" placeholder="Code" style="width: 400px">
            <input type="submit" style="color: #0b0b0b" value="Recharger" class="btn btn-secondary m-3">
        </form>
    </div>
	<!-- Shoping Cart -->
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
					<div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm" style="box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;">
