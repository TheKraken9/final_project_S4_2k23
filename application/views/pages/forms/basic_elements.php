                                        ...
                                        <?php foreach ($activite_sportive as $item): ?>
                                            <tr>
                                                ...
                                                <?php if($item->type == "Perdre du poids"){ ?>
                                                    <td class="text-success"><i class="ti-arrow-down"></i></td>
                                                <?php }else{ ?>
                                                    <td class="text-success"><i class="ti-arrow-up"></i></td>
                                                <?php } ?>
                                                <td><?= $item->category ?></td>
                                                <td><label class="badge badge-warning"><a href="<?= site_url("/index.php/Second/modifier?id="); ?><?= $item->id ?>" class="text-white">Modifier</a></label><label class="badge badge-danger m-2"><a href="<?= site_url("/index.php/Second/supprimer?id="); ?><?= $item->id ?>" class="text-white">Supprimer</a></label></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
