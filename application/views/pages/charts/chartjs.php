...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="<?= site_url("index.php/Welcome/backoffice"); ?>>"><img src="<?= base_url("images/logo.svg"); ?>" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="<?= site_url("index.php/Welcome/backoffice"); ?>>"><img src="<?= base_url("images/logo-mini.svg"); ?>" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="<?= base_url("images/faces/face28.jpg"); ?>" alt="profile"/>
            </a>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="<?= site_url("index.php/First/buttons"); ?>">Buttons</a></li>
                            <li class="nav-item"> <a class="nav-link" href="<?= site_url("index.php/First/dropdowns"); ?>">Dropdowns</a></li>
                            <li class="nav-item"> <a class="nav-link" href="<?= site_url("index.php/First/typography"); ?>">Typography</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="form-elements">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="<?= site_url("index.php/Second/basic_elements"); ?>">Basic Elements</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="collapse" id="charts">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="<?= site_url("index.php/Third/chartjs"); ?>">ChartJs</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
  ...
  <script src="<?= site_url("js/chart.js"); ?>"></script>
