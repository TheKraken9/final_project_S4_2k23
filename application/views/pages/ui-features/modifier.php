                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-description">
                                    Modification par aliment
                                </p>
                                <form class="forms-sample" method="post" action="<?= site_url("/index.php/First/modifier_aliment"); ?>">
                                    <?php foreach ($aliment as $item) : ?>
                                    <input type="hidden" name="id" value="<?= $item->id ?>">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Nom</label>
                                        <input type="text" name="nom" class="form-control" id="exampleInputUsername1" placeholder="nom" value="<?= $item->name ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Prix</label>
                                        <input type="number" name="prix" class="form-control" id="exampleInputEmail1" placeholder="prix" value="<?= $item->price ?>">
                                    </div>
                                    <div class="form-group">
