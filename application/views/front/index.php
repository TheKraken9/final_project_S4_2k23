	...
	<header>
		...
		<div class="container-menu-desktop">
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					<div class="left-top-bar">
						ETU : 1920 2663 1463 By ITUniverity
					</div>
					...
					<div class="right-top-bar flex-w h-full">
                        ...
                        <a href="<?= site_url("/index.php/Welcome/logout"); ?>" class="flex-c-m trans-04 p-lr-25">
                            Logout
                        </a>
					</div>
				</div>
			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="<?= site_url("/index.php/Welcome/frontoffice"); ?>" class="logo">
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="<?= site_url("/index.php/Welcome/frontoffice"); ?>"><img src="<?= base_url("images/icons/logo-01.png"); ?>" alt="IMG-LOGO"></a>
			</div>
				...
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="<?= base_url("images/item-cart-01.jpg"); ?>" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="<?= base_url("images/item-cart-02.jpg"); ?>" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="<?= base_url("images/item-cart-03.jpg"); ?>" alt="IMG">
						</div>
	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url(<?= base_url("images/slide-03.jpg"); ?>);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
			...
			<div class="row">
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="<?= base_url("images/banner-01.jpg"); ?>" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<?= base_url("images/banner-02.jpg"); ?>" alt="IMG-BANNER">
				...
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					<!-- Block1 -->
					<div class="block1 wrap-pic-w">
						<img src="<?= base_url("images/banner-03.jpg"); ?>" alt="IMG-BANNER">
		...
		<div class="container">
			...
			<div class="row isotope-grid">
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-01.jpg"); ?>" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="<?= site_url("/index.php/Welcome/product_detail"); ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									Esprit Ruffle Shirt
								</a>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-02.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-03.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-04.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-05.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-06.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-07.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-08.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item shoes">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-09.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-10.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-11.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item men">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-12.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-13.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-14.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item watches">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-15.jpg"); ?>" alt="IMG-PRODUCT">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?= base_url("images/product-16.jpg"); ?>" alt="IMG-PRODUCT">
		...
		<div class="container">
			...
			<div class="p-t-40">
                ...
                <p class="stext-107 cl6 txt-center">
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made in Betsileo <i class="fa fa-heart-o" aria-hidden="true"></i> by Leslie 1920 - Fenitra 2663 - Maminiaina 1463
                </p>
			</div>
		</div>
	</footer>
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="<?= base_url("images/product-detail-01.jpg"); ?>">
										<div class="wrap-pic-w pos-relative">
											<img src="<?= base_url("images/product-detail-01.jpg"); ?>" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= base_url("images/product-detail-01.jpg"); ?>">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="<?= base_url("images/product-detail-02.jpg"); ?>">
										<div class="wrap-pic-w pos-relative">
											<img src="<?= base_url("images/product-detail-02.jpg"); ?>" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= base_url("images/product-detail-02.jpg"); ?>">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>

									<div class="item-slick3" data-thumb="<?= base_url("images/product-detail-03.jpg"); ?>">
										<div class="wrap-pic-w pos-relative">
											<img src="<?= base_url("images/product-detail-03.jpg"); ?>" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?= base_url("images/product-detail-03.jpg"); ?>">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
