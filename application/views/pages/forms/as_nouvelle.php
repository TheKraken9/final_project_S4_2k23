            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Nouvelle activité sportive</h4>
                                <p class="card-description">
                                    Activité sportive
                                </p>
                                <form class="forms-sample" method="post" action="<?= site_url("/index.php/Second/nouvelle_as"); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" name="description" class="form-control" id="exampleInputEmail1" placeholder="Description"></textarea>
                                    </div>
                                    <div class="form-group">
