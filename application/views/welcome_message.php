                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="row">
                            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                ...
                                <h4 class="font-weight-bold">Your Email :  <?= $session['email']; ?></h4>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <ul class="icon-data-list">
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <img src="<?= site_url("images/faces/face2.jpg"); ?>" alt="user">
                                            <div>
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <img src="<?= site_url("images/faces/face3.jpg"); ?>" alt="user">
                                            <div>
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <img src="<?= site_url("images/faces/face4.jpg"); ?>" alt="user">
                                            <div>
                                    ...
                                    <li>
                                        <div class="d-flex">
                                            <img src="<?= site_url("images/faces/face5.jpg"); ?>" alt="user">
                                            <div>
