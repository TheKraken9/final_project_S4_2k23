...
<!--===============================================================================================-->
    ...
    <script src='<?= base_url('js/index.global.js') ?>'></script>
    <script src="<?= base_url('js/core/locales-all.global.js') ?>"></script>
    <!--===============================================================================================-->
</head>
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: [
                ...
                {
                    title: '<?= $item->name ?>' + ' (' + '<?= $item->price ?>' + ' Ar)',
                    start: today.setDate(today.getDate()+1)
                    <?php $prix += $item->price; ?>
                },
                <?php endforeach; ?>
                <?php foreach ($activite as $items): ?>
                {
                    title: '<?= $items->name ?>',
				...
				<nav class="limiter-menu-desktop container">
					...
					<div class="menu-desktop">
						<ul class="main-menu">
                            ...
                            <li>
                                <a href="<?= site_url("/index.php/Welcome/commencer"); ?>">Mon IMC</a>
                            </li>

                            <li>
                                <a href="<?= site_url("/index.php/Front/export_pdf"); ?>">Exporter</a>
                            </li>

                            <li>
                                <h4 class="bolder text-secondary"> Total: <?= $prix ?> Ariary</h4>
                            </li>
						</ul>
					</div>	
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="<?= site_url("/index.php/Welcome/logout"); ?>" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11">
