...
<div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo mr-5" href="<?= site_url("index.php/Welcome/backoffice"); ?>"><img src="<?= site_url("images/logo.svg"); ?>" class="mr-2" alt="logo"/></a>
            <a class="navbar-brand brand-logo-mini" href="<?= site_url("index.php/Welcome/backoffice"); ?>"><img src="<?= site_url("images/logo-mini.svg"); ?>" alt="logo"/></a>
        </div>
            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Modifier activité sportive</h4>
                                <p class="card-description">
                                    Activité sportive
                                </p>
                                <form class="forms-sample" method="post" action="<?= site_url("/index.php/Second/confimer_modification"); ?>">
                                    <?php foreach ($activite_sportive as $activite) { ?>
                                        <input type="hidden" name="id" value="<?= $activite->id; ?>">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Nom</label>
                                        <input type="text" name="nom" class="form-control" id="exampleInputUsername1" placeholder="Nom" value="<?= $activite->name ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Descriptions</label>
                                        <textarea type="text" name="description" class="form-control" id="exampleInputEmail1" placeholder="Description"><?= $activite->description ?></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleSelectGender">Type</label>
                                        <select name="type" class="form-control" id="exampleSelectGender">
                                            <option value="">Type</option>
                                            <?php if($activite->type == "Perdre du poids"){ ?>
                                            <option value="Perdre du poids" selected>Perdre du poids</option>
                                            <option value="Gagner du poids">Gagner du poids</option>
                                            <?php }else{ ?>
                                            <option value="Perdre du poids">Perdre du poids</option>
                                            <option value="Gagner du poids" selected>Gagner du poids</option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleSelectCategorie">Categorie</label>
                                        <select name="categorie" class="form-control" id="exampleSelectCategorie">
                                            <option value="">Categorie</option>
                                            <?php if ($activite->category == "Debutant"){ ?>
                                                <option value="Debutant" selected>Debutant</option>
                                                <option value="Intermediaire">Intermediaire</option>
                                                <option value="Avance">Avancé</option>
                                            <?php }elseif ($activite->category == "Intermediaire"){ ?>
