                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="<?= site_url("index.php/First/dropdowns"); ?>">Liste</a></li>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          <td class="py-1">
                            <img src="<?= site_url("images/faces/face1.jpg") ?>" alt="image"/>
                          </td>
                          <td>
                            Herman Beck
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="<?= site_url("images/faces/face2.jpg"); ?>" alt="image"/>
                          </td>
                          <td>
                            Messsy Adam
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="<?= site_url("images/faces/face3.jpg"); ?>" alt="image"/>
                          </td>
                          <td>
                            John Richards
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="<?= site_url("images/faces/face4.jpg"); ?>" alt="image"/>
                          </td>
                          <td>
                            Peter Meggik
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="<?= site_url("images/faces/face5.jpg"); ?>" alt="image"/>
                          </td>
                          <td>
                            Edward
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="<?= site_url("images/faces/face6.jpg"); ?>" alt="image"/>
                          </td>
                          <td>
                            John Doe
                          </td>
                        ...
                        <tr>
                          <td class="py-1">
                            <img src="<?= site_url("images/faces/face7.jpg"); ?>" alt="image"/>
                          </td>
                          <td>
                            Henry Tom
                          </td>
