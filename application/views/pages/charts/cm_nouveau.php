            ...
            <div class="content-wrapper">
                <div class="row">
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Nouveau code-money</h4>
                                <p class="card-description">
                                    Code Money
                                </p>
                                <form class="forms-sample" method="post" action="<?= site_url("/index.php/Third/nouveau_cm"); ?>">
                                    <div class="form-group">
                                        <label for="exampleInputUsername1">Code</label>
                                        <input type="number" name="code" class="form-control" id="exampleInputUsername1" placeholder="Code">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Tarifs</label>
                                        <input type="number" name="tarif" class="form-control" id="exampleInputEmail1" placeholder="Tarifs">
                                    </div>
